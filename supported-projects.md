...
Generated 2026-09-22T22:38:20Z. Written by the line manager reconciler.
...
|---|---|---|---|---|---|---|---|---|---|---|
| spring-boot-2.7.x | maven | `org.springframework.boot:spring-boot-dependencies@2.7.18` | in progress | 71 | 9 | 13% | 196 | 0 | 62 | 0 |
...
| org.eclipse.jetty:jetty-http | 9.4.58.v20250814 | spring-boot-2.7.x | listed by the BOM at 9.4.53.v20231009 (org.eclipse.jetty:jetty-bom@9.4.53.v20231009) | fixed | 1 | 1 | 100% | 1 | 0 | 0 | 0 | 9.4.58.v20250814-osera-00001 | 9.4.58.v20250814-osera-00001 | ready | complete | OK | OK | OK | OK | OK | OK | OK | OK | OK | OK |
...
3 component(s), 4 patched version(s). Expected parts of a line release (REL-009), not unexpected uploads.
...
| org.eclipse.jetty:jetty-bom | 9.4.58.v20250814 | BOM | imported by org.springframework.boot:spring-boot-dependencies@2.7.18 at 9.4.53.v20231009 | pins the patched modules (REL-009: a pinning BOM releases again) | 9.4.58.v20250814-osera-00001 | 9.4.58.v20250814-osera-00001 | broken | OK | OK | OK | NOK (the evidence names none and the vulnerability document names CVE-2026-2332) | OK | OK | OK | OK | OK | OK |
| org.eclipse.jetty:jetty-project | 9.4.58.v20250814 | parent | patch-jetty.project v9.4.58.v20250814-osera-00001 | the patched modules name it as their parent, a build needs it to resolve them | 9.4.58.v20250814-osera-00001 | 9.4.58.v20250814-osera-00001 | broken | OK | OK | OK | NOK (no vulnerability document next to the pom (jetty-project-9.4.58.v20250814-osera-00001-cyclonedx.json)) | OK | OK | OK | OK | OK | OK |
